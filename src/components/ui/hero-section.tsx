                        ...
                        <div className="lg:flex lg:items-center lg:gap-12">
                            <div className="relative z-10 mx-auto max-w-xl text-center lg:ml-0 lg:w-1/2 lg:text-left">
                                <a
                                    ...
                                    <span className="text-sm">ReloFinder.ch</span>
                                    <span className="bg-(--color-border) block h-4 w-px"></span>

                                    <ArrowRight className="size-4" />
                                </a>

                                <h1 className="mt-10 text-balance text-4xl font-bold md:text-5xl xl:text-5xl">Your Swiss Relocation Journey Starts Here</h1>
                                <p className="mt-8">Expert guidance and trusted services to make your move to Switzerland smooth and successful.</p>
                        ...
                        <div className="absolute inset-0 -mx-4 rounded-3xl p-3 lg:col-span-3">
                            ...
                            <div className="relative">
                                <img
                                    ...
                                    src="https://images.pexels.com/photos/3586966/pexels-photo-3586966.jpeg?auto=compress&cs=tinysrgb&w=1920"
