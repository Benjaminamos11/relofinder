        ...
        <div className="mb-6 space-y-2">
          {agency.phone && (
            <div className="flex items-center gap-2 text-sm text-gray-700">
              ...
              <a href={`tel:${agency.phone}`} className="hover:text-red-600">
                {agency.phone}
              </a>
            </div>
          )}
          {agency.email && (
            <div className="flex items-center gap-2 text-sm text-gray-700">
              ...
              <a href={`mailto:${agency.email}`} className="hover:text-red-600">
                {agency.email}
              </a>
            </div>
          )}
          {agency.website_url && (
            <div className="flex items-center gap-2 text-sm text-gray-700">
              ...
              <a href={agency.website_url} target="_blank" rel="noopener noreferrer" className="hover:text-red-600">
                Visit Website
              </a>
            </div>
          )}
