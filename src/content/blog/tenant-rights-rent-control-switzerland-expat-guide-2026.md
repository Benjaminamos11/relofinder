---
title: "Tenant Rights & Rent Control in Switzerland: The 2026 Expat Guide"
...
featured: false
faqs:
  - question: "Can I request a rent reduction if the mortgage reference rate drops?"
    answer: "Yes. If the reference rate has fallen since your lease began or since your last rent adjustment, you can request a reduction in writing. The rate is currently at 1.25% (September 2025). Landlords won't proactively lower rent — you must initiate the request yourself. Use the official cantonal form and submit within 30 days of the effective rate change."
  - question: "What happens if my landlord raises my rent by more than 10% in one go?"
    answer: "This is considered abusive under Swiss law. In cantons with mandatory disclosure (Basel-Stadt, Geneva, Zurich, Zug, Lucerne, Fribourg, parts of Vaud/Neuchâtel), landlords must justify rent increases using the official form showing the previous rent and reference rate. If the increase exceeds 10%, you have 30 days to contest it at your canton's conciliation authority (Schlichtungsbehörde)."
  - question: "Which Swiss cantons have rent control?"
    answer: "Geneva and Basel-Stadt have explicit cantonal rent regulations beyond federal law. Geneva's LDTR caps asking rents per room; Basel's rent control (WRFG) only applies when the cantonal vacancy rate falls below 1.5%. These laws stabilize existing rents but often result in higher asking rents for new tenants and longer rental periods."
  - question: "Do I need to use an official form to terminate my lease?"
    answer: "No, but your LANDLORD must use the official cantonal termination form (Formular Kündigung). A landlord notice sent by regular letter or email is legally void — even if the reason is valid. If you receive an informal termination, you can invoke this right. As a tenant, you can terminate using a registered letter (Einschreiben), but using the official form is safer."
  - question: "Can my landlord evict me if I request a rent reduction or report defects?"
    answer: "No. Swiss law explicitly prohibits retaliatory eviction. If your landlord terminates your lease within 3 years of you requesting a rent reduction, reporting maintenance issues, or asserting tenant rights, the termination is considered abusive (missbräuchlich / abusif). You have 30 days to contest it at the conciliation authority. The burden is on the landlord to prove the termination was not retaliatory."
  - question: "How long does my landlord have to return my deposit after I move out?"
    answer: "Typically 30-60 days for a clean exit inspection with no claims. Swiss law allows up to 1 year, but landlords should release deposits promptly if there are no disputes. The deposit is held in a blocked account (Sperrkonto) in YOUR name — landlords cannot access it without your co-signature or a court order. If deductions are made, they must be itemized with evidence (repair invoices). Dispute unfair deductions at the Schlichtungsbehörde free of charge."
  - question: "What's the new mandatory disclosure rule for landlords in 2026?"
    answer: "Since October 1, 2025, landlords in Basel-Stadt, Fribourg, Geneva, Lucerne, Zug, Zurich, and parts of Neuchâtel/Vaud must use an official form when setting initial rent. The form must disclose the previous tenant's rent AND the current mortgage reference rate and inflation rate. If the form is incomplete or uses outdated rates, the agreed-upon rent is invalid and you can contest it. This rule aims to curb excessive rent jumps when tenants change."
---
...
<p class="stat-card-label">Window to contest</p>
<p class="stat-card-desc">You have 30 days to challenge rent increases or terminations at the conciliation authority.</p>
</div>
<div class="stat-card">
<p class="stat-card-value">1.25 %</p>
<p class="stat-card-label">Reference rate 2026</p>
<p class="stat-card-desc">Mortgage reference rate as of Sept 2025 — if yours is higher, request a reduction.</p>
</div>
<div class="stat-card">
<p class="stat-card-value">10 %</p>
<p class="stat-card-label">Abusive threshold</p>
<p class="stat-card-desc">Rent increases over 10% at tenant change are considered abusive under Swiss law.</p>
</div>
</div>
...
<p class="callout-title"><span class="callout-icon">💡</span> Expat Tip</p>
<p>Always request the completed official rent form during apartment viewings. If the landlord refuses or says "it's not required," that's a red flag. In the 7 mandatory cantons, you're legally entitled to it.</p>
</div>
...
1. **Mortgage reference rate increases** — If the national reference rate rises, landlords can pass along a proportional increase (typically 2.9% rent increase per 0.25% rate hike).
2. **Inflation adjustments** — Landlords can raise rent by up to **40% of the inflation rate** since the last adjustment. Example: If CPI rises 5%, rent can increase by 2% (40% of 5%).
3. **Operating cost increases** — If property taxes, insurance, or management costs rise, landlords can pass these along. They can use a flat rate (e.g., 0.5%/year), but you can request proof.
4. **Property improvements** — Major renovations (new heating system, elevator, energy upgrades) justify increases. Minor repairs (repainting hallways, replacing a broken door) do not.
...
If your lease began in 2024 when the rate was 1.5%, you're entitled to a reduction now that it's 1.25%. Use the calculator on the [Federal Office for Housing website](https://www.bwo.admin.ch/) to determine the exact amount.

**How to request a reduction**:
1. Download the official rent-reduction form from your canton's website
2. Calculate the reduction using the reference rate table
3. Send the form via registered mail (*Einschreiben* / *envoi recommandé*)
4. Landlord has 30 days to respond
...
<p>Some rental agreements use "index-linked rents" (tied 1:1 to CPI, not the reference rate). In this case, inflation adjustments are automatic and the reference rate is irrelevant. Check your contract — it must explicitly state this.</p>
</div>
...
**Expat takeaway**: If you're moving to Geneva or Basel, ask whether the apartment is subject to cantonal rent control. In Geneva, this is almost always the case. In Basel, check the current vacancy rate on the [Federal Statistical Office portal](https://www.bfs.admin.ch/).
...
1. **Landlord must use the official cantonal termination form** (*Formular Kündigung* / *formule officielle de résiliation*). A notice sent by ordinary letter, email, or informal PDF is **legally void** — even if the reason is valid.
2. **Notice must arrive within the notice period** — typically 3 months for residential leases, ending on a fixed date (often the end of a month or quarter, depending on the lease).
3. **Tenant has 30 days to contest** at the conciliation authority if the termination is abusive.
...
<p class="callout-title"><span class="callout-icon">✅</span> Expat Win</p>
<p>If your landlord terminates informally (email, WhatsApp, unsigned letter), politely reply: "Under Swiss law, terminations must use the official cantonal form. Please resend via the correct procedure." This buys you time and establishes your awareness of your rights.</p>
</div>
...
1. Request itemized justification in writing
2. If unsatisfactory, file a claim at the *Schlichtungsbehörde* (free)
3. Bring photos from your move-in and exit inspections, the lease, and all correspondence
...
For insurance (mandatory within 3 months of arrival) and Pillar 3a setup (tax-deductible retirement savings up to CHF 7,258/year in 2026), consult [expat-savvy.ch](https://expat-savvy.ch) to structure your package efficiently.
