---
title: "Swiss Health Insurance Franchise 2026: The Expat Decision Guide"
description: "Choosing between CHF 300 and CHF 2,500 franchise can save you thousands. Learn the breakeven math, avoid the middle-tier trap, and optimize your 2026 health insurance costs."
publishDate: 2026-05-14
author: "relofinder"
heroImage: "/images/blog/health_insurance_hero.webp"
category: "Healthcare"
tags: ["health insurance", "franchise", "kvg", "cost optimization", "expats", "switzerland", "deductible"]
readingTime: 9
featured: false
faqs:
  - question: "What's the difference between CHF 300 and CHF 2,500 franchise?"
    answer: "The franchise is your annual deductible. With CHF 300, you pay higher monthly premiums but lower out-of-pocket costs. With CHF 2,500, you pay lower premiums but must cover the first CHF 2,500 of medical expenses yourself. After either franchise is met, you pay 10% coinsurance up to a CHF 700 annual cap."
  - question: "Which franchise should I choose if I'm healthy and rarely see a doctor?"
    answer: "If your annual medical costs are under CHF 1,800, choose the CHF 2,500 franchise. The premium savings (typically CHF 1,500-1,800/year) will outweigh your low medical costs. Set aside the monthly savings to build a medical reserve fund."
  - question: "When should I choose the CHF 300 franchise?"
    answer: "Choose CHF 300 if you expect annual medical costs above CHF 1,900 (chronic conditions, regular medications, planned surgeries, or pregnancy). For pregnancies, benefits from week 13 to 8 weeks post-birth are franchise-exempt, but complications are covered as illness."
  - question: "Are the middle-tier franchises (CHF 500, 1,000, 1,500, 2,000) worth it?"
    answer: "Almost never. The premium discount at these levels is proportionally smaller than the financial risk. The optimal strategy is binary: either CHF 300 (high care) or CHF 2,500 (low care). Middle tiers are statistically the worst financial outcome."
  - question: "Can I change my franchise mid-year if I get sick?"
    answer: "No. Franchise changes take effect January 1st only. To decrease your franchise, notify your insurer by November 30th. To increase it, notify by December 31st. Strategic timing matters—if you're planning pregnancy or surgery, switch to CHF 300 before the year it happens."
  - question: "What happens after I pay my franchise?"
    answer: "After meeting your franchise, you pay 10% coinsurance (Selbstbehalt) on further costs, capped at CHF 700/year for adults (CHF 350 for children). Your total maximum out-of-pocket is franchise + CHF 700. For CHF 2,500 franchise, that's CHF 3,200/year maximum."
  - question: "Are there any costs exempt from the franchise?"
    answer: "Yes. From 2026, key preventative vaccinations (diphtheria, tetanus, pneumococcal, meningitis) are franchise-exempt. Maternity care from week 13 to 8 weeks post-birth is fully covered. Some cantons offer free mammograms and colon cancer screenings for residents 50+, though coinsurance may still apply."
---
...
<div class="stat-grid">
<div class="stat-card">
<p class="stat-card-value">CHF 1,800</p>
<p class="stat-card-label">Breakeven threshold 2026</p>
<p class="stat-card-desc">Below this, CHF 2,500 franchise wins; above it, CHF 300 is optimal.</p>
</div>
<div class="stat-card">
<p class="stat-card-value">CHF 147/mo</p>
<p class="stat-card-label">Premium discount at max franchise</p>
<p class="stat-card-desc">Federal regulation caps CHF 2,500 discount at ~CHF 1,764/year vs CHF 300 baseline.</p>
</div>
<div class="stat-card">
<p class="stat-card-value">CHF 3,200</p>
<p class="stat-card-label">Maximum annual out-of-pocket</p>
<p class="stat-card-desc">CHF 2,500 franchise + CHF 700 coinsurance cap = worst-case total exposure.</p>
</div>
</div>
...
1. **Monthly premium** — fixed, paid whether you're healthy or sick.
2. **Franchise** — annual deductible (CHF 300–2,500).
3. **Coinsurance** (*Selbstbehalt*) — 10% of costs above the franchise, capped at CHF 700/year for adults.
...
<p class="callout-title"><span class="callout-icon">⚠️</span> The CHF 1,500 Trap</p>
<p>If you pick CHF 1,500 franchise and incur CHF 2,000 in costs, you pay CHF 1,500 + CHF 50 coinsurance = CHF 1,550 out-of-pocket, plus you've been paying higher premiums all year (only CHF 960 annual discount vs CHF 1,764 for CHF 2,500). You've lost on both ends.</p>
</div>
...
<p class="callout-title"><span class="callout-icon">💡</span> Insider Tip: The November Deadline Overlaps</p>
<p>The November 30th deadline for franchise changes *coincides* with the deadline to switch insurers. If you're optimizing both, coordinate the moves—some insurers offer better premium discounts at CHF 2,500 than others. Use [primai.ch](https://primai.ch) or Comparis to compare total-cost scenarios across insurers *and* franchises simultaneously.</p>
</div>
...
1. Open a separate savings account (or use a high-interest pillar 3b account via [expat-savvy.ch/3rd-pillar/](https://expat-savvy.ch/3rd-pillar/)).
2. Auto-transfer CHF 150/month into it.
3. After 17 months, you've saved CHF 2,550—enough to cover the full deductible if needed.
4. In years 3+, you're "playing with house money"—every healthy year banks another CHF 1,764 in savings.
...
If you're working with a [relocation agency](https://primerelocation.ch) or [lifestyle manager](https://lifestylemanagers.ch), they'll often recommend franchise selection during your insurance setup. But remember: **they're optimizing for simplicity, not cost**. Many will default to CHF 1,000 or CHF 1,500 because it "feels balanced."

If you want true optimization, either:

1. Run the math yourself using the 1,800 heuristic.
2. Book a consultation with a Swiss-focused insurance advisor such as [ThatDay.ch](https://thatday.ch/gesundheit/?source=relofinder-franchise-body) or [insurance-guide.ch](https://insurance-guide.ch) who can model your specific medical profile. Established Swiss families with semi-private or private hospital coverage and broader Vorsorge needs should review the whole setup, not just the cheapest KVG premium.
...
<p>If you're under 45, healthy, and have no chronic conditions, the CHF 2,500 franchise + self-insurance savings account is the statistically superior play. Over 10 years, assuming 7 healthy years and 3 moderate-cost years (CHF 1,500 each), you'll save ~CHF 8,000 net vs. holding CHF 300 the whole time.</p>
</div>
...
1. **Calculate last year's medical costs** (GP visits + specialists + medications + procedures). If < CHF 1,800, CHF 2,500 is optimal. If > CHF 1,900, CHF 300 is optimal.
2. **Avoid middle-tier franchises** unless you have a very specific cost prediction (rare).
3. **Coordinate with family members** — each can hold a different franchise.
4. **Set up auto-savings** if choosing CHF 2,500 — transfer monthly premium savings to a separate account.
5. **Check canton-specific exemptions** — some cantons offer additional franchise-free screenings.
6. **Plan for life changes** — if pregnancy, surgery, or new chronic condition is expected in 2027, switch to CHF 300 by Nov 30, 2026.
7. **Review annually** — your optimal franchise can change as your health profile evolves.
...
## Ready to Optimize Your Swiss Relocation?

The franchise decision is just one piece of your Swiss financial puzzle. From choosing the right [health insurance model](https://relofinder.ch/blog/how-to-compare-switch-swiss-health-insurance-2026) to navigating [relocation agency costs](https://relofinder.ch/blog/relocation-agency-costs-switzerland-2026), every decision compounds.

Take the [2-minute relocation assessment](/assessment/) to get personalized recommendations on insurance, housing, and financial planning—tailored to your expat profile.
