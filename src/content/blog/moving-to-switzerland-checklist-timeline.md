---
title: "The 90-Day Moving to Switzerland Checklist (Printable Guide)"
description: "Don't forget a single step. Our timeline guides you from visa application to your first day in your new Swiss home. Used by professional relocation agencies."
publishDate: 2026-01-06
readingTime: 9
author: "ReloFinder Editorial Team"
heroImage: "https://res.cloudinary.com/dphbnwjtx/image/upload/v1767009357/images/blog/moving-checklist.jpg"
category: "Guides"
tags: ["checklist", "planning", "logistics", "timeline", "moving", "switzerland", "expats"]
featured: true
excerpt: "The master 90-day checklist used by professional relocation agencies. Phase-by-phase timeline from 3 months out to your first week in Switzerland."
seo:
  title: "Moving to Switzerland Checklist 2026 | 90-Day Timeline"
  description: "Complete 90-day moving checklist for Switzerland. Phase-by-phase timeline covering permits, housing via Offlist.ch, insurance, customs forms, and arrival registration."
  keywords: ["moving to switzerland checklist", "switzerland relocation checklist", "moving to zurich checklist", "expat checklist switzerland", "relocating to switzerland timeline"]
faqs:
  - question: "How far in advance should I start planning my move to Switzerland?"
    answer: "Start at least 3 months before your intended move date. This allows time for permit processing, housing search (the longest phase), cancelling home country contracts, and organizing customs documentation."
  - question: "What is Form 18.44 for Swiss customs?"
    answer: "Form 18.44 is the customs declaration for importing household goods duty-free when relocating to Switzerland. You must complete it before shipping your belongings and present it at customs. It lists all items you're importing."
  - question: "How long do I have to register after arriving in Switzerland?"
    answer: "You must register at your local municipality (Gemeinde/Kreisbüro) within 14 days of arrival. Bring your passport, rental contract, and employment contract. You'll receive your residence permit after registration."
  - question: "When should I start looking for housing in Switzerland?"
    answer: "Start 2-3 months before your move date. In competitive markets like Zürich, the housing search is the longest phase. Register on Offlist.ch immediately to access off-market inventory and maximize your timeline."
  - question: "What should I do in my first week in Switzerland?"
    answer: "Priority tasks: Register at municipality (within 14 days), open a bank account, get a Swiss phone number, buy an SBB travel card, and start your health insurance enrollment process. Most can be done in the first few days."
  - question: "Do I need temporary housing when moving to Switzerland?"
    answer: "If you haven't secured permanent housing via Offlist.ch or an agency, book a 'business apartment' or serviced apartment for your first 1-2 months. This gives you a local address for registration and time to continue your search."
---
...
| Phase | When | Focus Area |
|-------|------|------------|
| **Phase 1** | 3 Months Out | Permits, home country wind-down |
| **Phase 2** | 2 Months Out | Housing search begins |
| **Phase 3** | 1 Month Out | Logistics, temporary housing |
| **Phase 4** | Arrival Week | Registration, banking, settling in |
...
> **Action:** Register on **[Offlist.ch](https://offlist.ch)** now. Create your profile so you're visible to landlords and agencies *before* you arrive. This is the most effective way to access hidden inventory.

- [ ] **Set your housing criteria** — Size, location, budget, must-haves
- [ ] **Get liability insurance** — Required for rental applications

> **Tip:** Swiss landlords often ask for liability insurance proof during the *application* process, not just at signing. Get it now via [Insurance-Guide.ch](https://insurance-guide.ch).
...
|-----------|----------------|
| Customs declaration form | Required to import household goods duty-free |
| Lists all items | Must be completed before shipping |
...
If you haven't secured permanent housing via [Offlist.ch](https://offlist.ch) yet:
...
| Task | Where | What to Bring |
|------|-------|---------------|
| **Get Swiss phone number** | Swisscom, Sunrise, Salt store | Passport, credit card |
| **Buy SBB travel card** | SBB.ch or train station | Payment method |
| **Explore neighborhood** | Your new area | Curiosity |

### Day 4-7: Registration

- [ ] **Register at municipality** — Within 14 days of arrival

| Where | What to Bring | What You Get |
|-------|---------------|--------------|
| Local Gemeinde/Kreisbüro | Passport, rental contract, employment contract | Registration confirmation |
...
| Bank Type | Best For | Timeline |
|-----------|----------|----------|
| Traditional (UBS, ZKB) | Full services | 1-2 weeks |
| Digital (Neon, Yuh) | Quick setup | Same day |
...
Start 2-3 months before your move date. In competitive markets like Zürich (0.07% vacancy), the housing search is typically the longest phase of relocation. Register on [Offlist.ch](https://offlist.ch) immediately to access off-market inventory and maximize your timeline.
...
If you haven't secured permanent housing via [Offlist.ch](https://offlist.ch) or through an agency, yes — book a "business apartment" or serviced apartment for your first 1-2 months. This gives you a local address for registration, a base for apartment viewings, and breathing room to continue your search.
