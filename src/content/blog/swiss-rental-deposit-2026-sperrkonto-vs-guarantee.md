---
title: "Swiss Rental Deposit 2026: Sperrkonto vs. Guarantee — Which Saves You More?"
description: "Switzerland caps rental deposits at 3 months' rent. Compare blocked accounts vs. deposit guarantee insurance, legal deduction rules, and how to get every franc back."
publishDate: 2026-06-02
author: "relofinder"
heroImage: "/images/blog/zurich-apartments.webp"
category: "Housing & Living"
tags: ["rental deposit", "Mietkaution", "Sperrkonto", "housing", "tenant rights", "Switzerland"]
readingTime: 13
featured: false
faqs:
  - question: "Can my landlord demand more than 3 months' rent as a deposit?"
    answer: "No. Swiss law (Art. 257e OR) caps residential rental deposits at three months' net rent. Any amount above that is legally void, and you can challenge it at the cantonal conciliation authority (Schlichtungsbehörde)."
  - question: "What's cheaper long-term: Sperrkonto or deposit guarantee insurance?"
    answer: "A Sperrkonto (blocked bank account) is cheaper long-term because you get 100% of your money back plus interest. Guarantee insurance costs 3.5–5% annually and is never refunded — over 5 years, that's CHF 525–750 vs. CHF 0 for a Sperrkonto on a CHF 3,000 deposit."
  - question: "Can I refuse to pay the deposit into my landlord's personal account?"
    answer: "Yes. Swiss law requires deposits to be held in a blocked account in the tenant's name. The Swiss Tenants' Association (Mieterverband) explicitly states you can refuse cash payment or transfer to a landlord's private account."
  - question: "How long can my landlord keep my deposit after I move out?"
    answer: "If the landlord has not legally asserted a claim within one year after the tenancy ends, you can demand the deposit back from the bank directly (Art. 257e OR). Most landlords settle within 4–8 weeks if there are no disputes."
  - question: "Do all landlords accept deposit guarantee insurance?"
    answer: "No. Landlords must consent to accept a guarantee instead of a Sperrkonto. Many prefer the bank deposit because it's simpler. Always confirm with your landlord or property management before purchasing a guarantee policy."
  - question: "What can my landlord legally deduct from my deposit?"
    answer: "Only documented damages beyond normal wear-and-tear, unpaid rent, and outstanding utility bills. The landlord must provide receipts and itemized breakdowns. Faded paint, minor scratches, and aged carpets after 5+ years typically don't qualify."
  - question: "Can I transfer my deposit guarantee insurance to a new apartment?"
    answer: "No. Most providers (AXA, SwissCaution) require you to cancel when your lease ends and purchase a new policy for the next apartment. You may get a pro-rated refund of the current year's premium."
---
...
<p class="stat-card-label">Legal deposit cap (net rent)</p>
<p class="stat-card-desc">Art. 257e OR — any amount above is void.</p>
</div>
<div class="stat-card">
<p class="stat-card-value">CHF 525–750</p>
<p class="stat-card-label">5-year cost of guarantee insurance</p>
<p class="stat-card-desc">vs. CHF 0 for Sperrkonto (you get 100% back).</p>
</div>
<div class="stat-card">
<p class="stat-card-value">1 year</p>
<p class="stat-card-label">Landlord claim deadline after move-out</p>
<p class="stat-card-desc">After that, bank must return deposit to you.</p>
</div>
</div>
...
<p>Some landlords calculate the 3-month cap incorrectly by including Nebenkosten. Example: CHF 2,000 rent + CHF 300 Nebenkosten = CHF 2,300 total, but the deposit cap is CHF 6,000 (3 × CHF 2,000), NOT CHF 6,900. Always confirm the base rent figure.</p>
</div>
...
<p>Some guarantee providers (SwissCaution) offer **loyalty discounts**: 10% after 2 years, 20% after 3 years, 30% after 4 years. If your landlord insists on insurance, negotiate for a provider with these discounts to cut long-term costs.</p>
</div>

If you're struggling to decide between the two, **[offlist.ch](https://offlist.ch)** connects you with off-market rental opportunities where landlords may be more flexible on deposit terms — especially if you have a strong profile.

## What Can Your Landlord Legally Deduct?

Swiss law allows landlords to deduct from your deposit **only** for:

1. **Unpaid rent or utility bills** (must be documented with invoices).
2. **Damages beyond normal wear-and-tear** (Abnützung vs. Beschädigung).
3. **Cleaning costs** (if the apartment wasn't returned in the contractually agreed condition).
...
<p>Take **time-stamped photos + video** of the apartment on move-in day (every room, appliances, floors, walls) and on move-out day. Store them in Google Photos or Dropbox with visible dates. This evidence is decisive in conciliation hearings.</p>
</div>

For specialized relocation services that include move-in/move-out protocol support, **[primerelocation.ch](https://primerelocation.ch)** and **[lifestylemanagers.ch](https://lifestylemanagers.ch)** offer premium packages for expats moving to Zurich, Geneva, and Zug.
...
**Critical legal timeline (Art. 257e OR):**
If the landlord has **not asserted a claim within one year** after the tenancy ends, you can demand the deposit back **directly from the bank**. The landlord's window to dispute deductions closes after 12 months.
...
For tailored financial advice on managing Swiss moving costs, liquidity, and pillar 3a optimization during relocation, **[expat-savvy.ch](https://expat-savvy.ch)** specializes in expat financial planning.
...
### 4. Claims Process
If the landlord files a claim, the insurer pays the landlord first, then **bills you** for reimbursement. You're still 100% liable — the insurance just acts as a middleman. This is **not** like household liability insurance (Privathaftpflichtversicherung), which actually covers accidental damages. For tenant liability coverage, **[insurance-guide.ch](https://insurance-guide.ch)** compares Swiss liability policies starting at CHF 80/year.
...
For a complete guide to pillar 3a optimization (including pledge strategies), **[expat-savvy.ch/3rd-pillar/](https://expat-savvy.ch/3rd-pillar/)** offers step-by-step walkthroughs.
...
<div class="callout callout-info">
<p class="callout-title"><span class="callout-icon">💡</span> Insider Tip</p>
<p>Join the Swiss Tenants' Association (Mieterverband / ASLOCA) for CHF 80–120/year. Membership includes free legal advice, template letters, and representation at conciliation hearings — often saving you CHF 500+ in the first dispute alone.</p>
</div>
...
1. **Choose a bank:** Most Swiss banks offer Sperrkonto accounts. Fees vary:
...
3. **Bank opens account in your name** and issues a **pledge certificate** (Verpfändungserklärung) to your landlord. This document gives the landlord the right to claim the deposit under specific conditions (unpaid rent, damages).

4. **Transfer the deposit amount** (e.g., CHF 6,000) into the Sperrkonto. The account is now "blocked" — you cannot withdraw without landlord consent.

5. **Give the pledge certificate to your landlord.** Keep a copy for your records.
...
For comprehensive Swiss banking setup (including Sperrkonto guidance), **[primerelocation.ch](https://primerelocation.ch)** offers full-service relocation packages.
...
1. Contact your landlord and explain you want to replace the guarantee with a cash deposit.
2. Open a Sperrkonto and deposit the full amount.
3. Landlord signs a release letter returning the insurance guarantee certificate to the provider.
4. Provider cancels the policy; you may get a pro-rated premium refund (depends on provider).
...
**[Take the 2-minute relocation assessment](/assessment/)** to get personalized recommendations for housing, insurance, and financial setup — tailored to your canton, income, and family situation. Built by expats who've done this 500+ times.
